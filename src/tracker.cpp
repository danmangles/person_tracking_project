...
void tracker::generate_coord_array (pcl::PointCloud<pcl::PointXYZ>::Ptr input_cloud, vector<Eigen::Vector3f> &centroid_coord_array) {
...
void tracker::generate_centroid(pcl::PointCloud<pcl::PointXYZ>::Ptr cluster_ptr, Vector3f &coord_centroid) {
